...
namespace NFCLoc.Plugin.Lock
{
    [Export(typeof(INFCLocServicePlugin))]
    public class LockWorkstation : INFCLocServicePlugin
    {
        ...
        public void NCFRingDown(string id, Dictionary<string, object> parameters, SystemState state)
        {
            ...
            {
                NFCLoc.Service.Core.ServiceCore.Log("LockWorkstationPlugin: Exception thrown: " + ex.Message);
            }
        }
        ...
        public class ProcessAsUser
        {
            ...
            private static bool LaunchProcessAsUser(string cmdLine, IntPtr token, IntPtr envBlock)
            {
                ...
                if (result == false)
                {
                    ...
                    NFCLoc.Service.Core.ServiceCore.Log("LockWorkstationPlugin: Error " + message);
            ...
            private static IntPtr GetPrimaryToken(int processId)
            {
                ...
                catch (ArgumentException)
                {
                    ...
                    NFCLoc.Service.Core.ServiceCore.Log("LockWorkstationPlugin: " + details);
                ...
                if (retVal == true)
                {
                    ...
                    if (retVal == false)
                    {
                        ...
                        NFCLoc.Service.Core.ServiceCore.Log("LockWorkstationPlugin: " + message);
                        //Debug.WriteLine(message);
                    }
            ...
            public static bool Launch(string appCmdLine /*,int processId*/)
            {
                ...
                if (processId > 1)
                {
                    ...
                    if (token != IntPtr.Zero)
                    {
                        ...
                        if(!ret)
                        {
                            NFCLoc.Service.Core.ServiceCore.Log("LockWorkstationPlugin: lock failed");
                        }
                ...
                {
                    NFCLoc.Service.Core.ServiceCore.Log("LockWorkstationPlugin: process not found");
                }
                return ret;
            }
